...
**data** | [**{ [key: string]: APIResponsePipelineStatusAllOfData; }**](APIResponsePipelineStatusAllOfData.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponsePipelineStatus } from './api';

const instance: APIResponsePipelineStatus = {
    status,
    data,
    message,
    errors,
