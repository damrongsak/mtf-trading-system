...
**data** | [**Array&lt;ChatSession&gt;**](ChatSession.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseChatSessionList } from './api';

const instance: APIResponseChatSessionList = {
    status,
    data,
    message,
    errors,
