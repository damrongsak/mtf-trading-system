...
**data** | [**FactorExposures**](FactorExposures.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseFactorExposures } from './api';

const instance: APIResponseFactorExposures = {
    status,
    data,
    message,
    errors,
