...
**data** | [**RiskCheckResponse**](RiskCheckResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseRiskCheckResponse } from './api';

const instance: APIResponseRiskCheckResponse = {
    status,
    data,
    message,
    errors,
