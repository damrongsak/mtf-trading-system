...
**data** | [**BacktestResponse**](BacktestResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseBacktestResponse } from './api';

const instance: APIResponseBacktestResponse = {
    status,
    data,
    message,
    errors,
