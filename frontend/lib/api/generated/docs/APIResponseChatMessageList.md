...
**data** | [**Array&lt;ChatMessage&gt;**](ChatMessage.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseChatMessageList } from './api';

const instance: APIResponseChatMessageList = {
    status,
    data,
    message,
    errors,
