...
**data** | [**Array&lt;APIResponseOrchestrationLogsAllOfData&gt;**](APIResponseOrchestrationLogsAllOfData.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseOrchestrationLogs } from './api';

const instance: APIResponseOrchestrationLogs = {
    status,
    data,
    message,
    errors,
