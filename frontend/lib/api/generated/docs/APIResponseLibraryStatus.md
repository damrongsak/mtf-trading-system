...
**data** | [**APIResponseLibraryStatusAllOfData**](APIResponseLibraryStatusAllOfData.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseLibraryStatus } from './api';

const instance: APIResponseLibraryStatus = {
    status,
    data,
    message,
    errors,
