...
**data** | [**Array&lt;APIResponseLibraryBookListAllOfData&gt;**](APIResponseLibraryBookListAllOfData.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseLibraryBookList } from './api';

const instance: APIResponseLibraryBookList = {
    status,
    data,
    message,
    errors,
