...
**data** | [**DrawdownMetrics**](DrawdownMetrics.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseDrawdownMetrics } from './api';

const instance: APIResponseDrawdownMetrics = {
    status,
    data,
    message,
    errors,
