...
**data** | [**Array&lt;BrokerAccount&gt;**](BrokerAccount.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseBrokerAccountList } from './api';

const instance: APIResponseBrokerAccountList = {
    status,
    data,
    message,
    errors,
