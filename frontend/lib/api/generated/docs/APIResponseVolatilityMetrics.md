...
**data** | [**VolatilityMetrics**](VolatilityMetrics.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseVolatilityMetrics } from './api';

const instance: APIResponseVolatilityMetrics = {
    status,
    data,
    message,
    errors,
