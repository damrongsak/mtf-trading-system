...
**data** | [**UserPreferencesResponse**](UserPreferencesResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseUserPreferencesResponse } from './api';

const instance: APIResponseUserPreferencesResponse = {
    status,
    data,
    message,
    errors,
