...
**data** | [**LatencyHeatmapResponse**](LatencyHeatmapResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseLatencyHeatmap } from './api';

const instance: APIResponseLatencyHeatmap = {
    status,
    data,
    message,
    errors,
