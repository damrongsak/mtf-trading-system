...
**data** | [**APIResponseIngestionResultAllOfData**](APIResponseIngestionResultAllOfData.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseIngestionResult } from './api';

const instance: APIResponseIngestionResult = {
    status,
    data,
    message,
    errors,
