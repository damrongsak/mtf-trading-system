...
**data** | [**APIResponseTransactionImportResponseAllOfData**](APIResponseTransactionImportResponseAllOfData.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseTransactionImportResponse } from './api';

const instance: APIResponseTransactionImportResponse = {
    status,
    data,
    message,
    errors,
