...
**data** | [**StrategyResponse**](StrategyResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseStrategyResponse } from './api';

const instance: APIResponseStrategyResponse = {
    status,
    data,
    message,
    errors,
