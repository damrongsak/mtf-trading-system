...
**data** | [**WalkForwardResponse**](WalkForwardResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseWalkForwardResponse } from './api';

const instance: APIResponseWalkForwardResponse = {
    status,
    data,
    message,
    errors,
