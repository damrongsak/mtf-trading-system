...
**data** | [**ExecutionRejectionResponse**](ExecutionRejectionResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponseExecutionRejection } from './api';

const instance: APIResponseExecutionRejection = {
    status,
    data,
    message,
    errors,
