...
**data** | [**PerformanceComparisonResponse**](PerformanceComparisonResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { APIResponsePerformanceComparison } from './api';

const instance: APIResponsePerformanceComparison = {
    status,
    data,
    message,
    errors,
