...
class DocStructure(BaseModel):
    ...
    key_entities: List[str] = Field(..., description="Most prominent organizations, assets, or people mentioned")
    structure_map: List[str] = Field(..., description="Mental map of the document (sections and their purpose)")
    suggested_ontology_labels: List[str] = Field(..., description="Which Olympus labels are most relevant for this doc")
